...
void
initLineNumberArray (LineNumberArray *array)
{
  array->count = 0;
  array->capacity = 0;
...
int
writeNumber (LineNumberArray *array, int lineNumber)
{
  if (array->count > 0
...
int *
decompressLineNumberArray (LineNumberArray *array)
{
...
int
numberOfEntries (LineNumberArray *array)
{
...
void
freeLineNumberArray (LineNumberArray *array)
{
