...
static inline bool isCharacter(Value value) {
  // Something is a character if:
  // 1. It is a number
  return IS_NUMBER(value) &&
         // 2. It is in the range of a character
         (CHAR_MIN <= AS_NUMBER(value) && AS_NUMBER(value) <= CHAR_MAX) &&
         // 3. It is a whole number.
         (double)(long)AS_NUMBER(value) == AS_NUMBER(value);
}
